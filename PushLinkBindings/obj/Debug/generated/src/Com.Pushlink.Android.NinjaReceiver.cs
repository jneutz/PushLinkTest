...
namespace Com.Pushlink.Android {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.pushlink.android']/class[@name='NinjaReceiver']"
	[global::Android.Runtime.Register ("com/pushlink/android/NinjaReceiver", DoNotGenerateAcw=true)]
	public partial class NinjaReceiver : global::Android.Content.BroadcastReceiver {

		internal static IntPtr java_class_handle;
		internal static IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/pushlink/android/NinjaReceiver", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (NinjaReceiver); }
		}

		protected NinjaReceiver (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.pushlink.android']/class[@name='NinjaReceiver']/constructor[@name='NinjaReceiver' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe NinjaReceiver ()
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				if (GetType () != typeof (NinjaReceiver)) {
					SetHandle (
...
#pragma warning disable 0169
		...
		{
			global::Com.Pushlink.Android.NinjaReceiver __this = global::Java.Lang.Object.GetObject<global::Com.Pushlink.Android.NinjaReceiver> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.pushlink.android']/class[@name='NinjaReceiver']/method[@name='onReceive' and count(parameter)=2 and parameter[1][@type='android.content.Context'] and parameter[2][@type='android.content.Intent']]"
